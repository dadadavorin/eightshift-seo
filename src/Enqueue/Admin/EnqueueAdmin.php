	...
	private function buildEditorLocalization(): array
	{
		return [
			...
			'metaKeys'   => [
				...
				'twitterCardType'    => Options::getMetaKey('twitterCardType'),
				'focusKeyphrase'     => Options::getMetaKey('focusKeyphrase'),
				'primaryCategory'    => Options::getMetaKey('primaryCategory'),
				...
				'noarchive'          => Options::getMetaKey('noarchive'),
				'nosnippet'          => Options::getMetaKey('nosnippet'),
				'noimageindex'       => Options::getMetaKey('noimageindex'),
				'notranslate'        => Options::getMetaKey('notranslate'),
				'unavailableAfter'   => Options::getMetaKey('unavailableAfter'),
				'hreflangDisabled'   => Options::getMetaKey('hreflangDisabled'),
				'noai'               => Options::getMetaKey('noai'),
				'noimageai'          => Options::getMetaKey('noimageai'),
				'tldr'               => Options::getMetaKey('tldr'),
				'citations'          => Options::getMetaKey('citations'),
				'speakableSelectors' => Options::getMetaKey('speakableSelectors'),
				'faq'                => Options::getMetaKey('faq'),
				'howto'              => Options::getMetaKey('howto'),
				'dateReviewed'       => Options::getMetaKey('dateReviewed'),
				'definitionTerm'     => Options::getMetaKey('definitionTerm'),
			],
			'homeUrl'    => \home_url('/'),
