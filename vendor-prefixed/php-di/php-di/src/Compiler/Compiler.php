...
use function chmod;
use EightshiftSeoVendor\DI\Definition\ArrayDefinition;
use EightshiftSeoVendor\DI\Definition\DecoratorDefinition;
...
use EightshiftSeoVendor\DI\Definition\Source\DefinitionSource;
...
use EightshiftSeoVendor\DI\Proxy\ProxyFactoryInterface;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use EightshiftSeoVendor\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
    ...
    private function compileDefinition(string $entryName, Definition $definition) : string
    {
        ...
        switch (true) {
            ...
            case $definition instanceof StringDefinition:
                ...
                $code = 'return \EightshiftSeoVendor\DI\Definition\StringDefinition::resolveExpression(' . $entryName . ', ' . $expression . ', $this->delegateContainer);';
                break;
            case $definition instanceof EnvironmentVariableDefinition:
                ...
                $code = <<<PHP
                            ...
                            if (!$isOptional) {
                                throw new \EightshiftSeoVendor\DI\Definition\Exception\InvalidDefinition("The environment variable '{$definition->getVariableName()}' has not been defined");
                            }
                            return $defaultValue;
                    PHP;
                break;
