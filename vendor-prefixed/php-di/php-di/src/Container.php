...
use EightshiftSeoVendor\DI\Definition\Resolver\ResolverDispatcher;
use EightshiftSeoVendor\DI\Definition\Source\DefinitionArray;
use EightshiftSeoVendor\DI\Definition\Source\MutableDefinitionSource;
use EightshiftSeoVendor\DI\Definition\Source\ReflectionBasedAutowiring;
use EightshiftSeoVendor\DI\Definition\Source\SourceChain;
use EightshiftSeoVendor\DI\Definition\ValueDefinition;
use EightshiftSeoVendor\DI\Invoker\DefinitionParameterResolver;
use EightshiftSeoVendor\DI\Proxy\NativeProxyFactory;
use EightshiftSeoVendor\DI\Proxy\ProxyFactory;
use EightshiftSeoVendor\DI\Proxy\ProxyFactoryInterface;
use InvalidArgumentException;
use EightshiftSeoVendor\Invoker\Invoker;
use EightshiftSeoVendor\Invoker\InvokerInterface;
use EightshiftSeoVendor\Invoker\ParameterResolver\AssociativeArrayResolver;
use EightshiftSeoVendor\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain DI definitions, e.g. \EightshiftSeoVendor\DI\get().
     *
