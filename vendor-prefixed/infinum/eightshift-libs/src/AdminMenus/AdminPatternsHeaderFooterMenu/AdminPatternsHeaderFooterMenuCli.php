 ...
 *
 * @package EightshiftSeoVendor\EightshiftLibs\AdminMenus\AdminPatternsHeaderFooterMenu
 *
 * @license MIT
...
namespace EightshiftSeoVendor\EightshiftLibs\AdminMenus\AdminPatternsHeaderFooterMenu;
