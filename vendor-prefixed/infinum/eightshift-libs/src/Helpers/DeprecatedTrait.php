...
namespace EightshiftSeoVendor\EightshiftLibs\Helpers;

use EightshiftSeoVendor\EightshiftLibs\Exception\InvalidManifest;
use EightshiftSeoVendor\EightshiftLibs\Rest\Routes\AbstractRoute;
